...
// Event selections on anniversaries pages (like https://en.wikipedia.org/wiki/Wikipedia:Selected_anniversaries/January_30 ) often
...
describe('onthisday', function() {
    ...
    */
    ...
    it('anniversariesURIForRequest returns expected URI for 0 padded month and 2 digit day', () => {
        assert.deepEqual(onThisDay.testing.anniversariesURIForRequest(REQUEST_FOR_EN_01_30), 'https://en.wikipedia.org/api/rest_v1/page/html/Wikipedia%3ASelected_anniversaries%2FJanuary_30');
    });
    it('anniversariesURIForRequest returns expected URI for 2 digit month and 0 padded day', () => {
        assert.deepEqual(onThisDay.testing.anniversariesURIForRequest(REQUEST_FOR_EN_12_01), 'https://en.wikipedia.org/api/rest_v1/page/html/Wikipedia%3ASelected_anniversaries%2FDecember_1');
    });
    it('anniversariesURIForRequest returns expected URI for 1 digit month and 1 digit day', () => {
        assert.deepEqual(onThisDay.testing.anniversariesURIForRequest(REQUEST_FOR_EN_1_1), 'https://en.wikipedia.org/api/rest_v1/page/html/Wikipedia%3ASelected_anniversaries%2FJanuary_1');
    });
    ...
    it('getAnniversariesHTMLForRequest can fetch an anniversaries page', () => {
        return onThisDay.testing.getAnniversariesHTMLForRequest(REQUEST_FOR_EN_01_30)
            .then((res) => {
                assert.status(res, 200);
            });
    });
