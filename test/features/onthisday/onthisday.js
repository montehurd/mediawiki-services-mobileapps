...
describe('onthisday', function() {
    ...
    it('"holidays" should respond to GET request with expected headers, incl. CORS and CSP headers', () => {
    ...
    it('WMFEvent model object is correctly created from a selected list element', () => {
        assert.deepEqual(onThisDay.testing.WMFEventFromListElement(SEABISCUIT_SELECTED_LIST_ELEMENT), {
    ...
    it('WMFEvent model object is correctly created from a birth list element', () => {
        assert.deepEqual(onThisDay.testing.WMFEventFromListElement(LIVIA_BIRTH_LIST_ELEMENT), {
    ...
    it('WMFEvent model object is correctly created from an event list element', () => {
        assert.deepEqual(onThisDay.testing.WMFEventFromListElement(TEMPLE_EVENT_LIST_ELEMENT), {
    ...
    it('WMFEvent model object is correctly created from a death list element', () => {
        assert.deepEqual(onThisDay.testing.WMFEventFromListElement(GANDHI_DEATH_LIST_ELEMENT), {
    ...
    it('WMFHoliday model object is correctly created from a holiday list element', () => {
        assert.deepEqual(onThisDay.testing.WMFHolidayFromListElement(MARTYRDOM_HOLIDAY_LIST_ELEMENT), {
    ...
    it('Sort year list events in correct BC[E] aware manner', () => {
        const sortedEvents = onThisDay.testing.eventsForYearListElements(MOCK_EVENT_LIST_ELEMENTS).sort(onThisDay.testing.bcAwareEventComparator);
