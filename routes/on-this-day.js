 ...
 * https://en.m.wikipedia.org/wiki/Wikipedia%3ASelected_anniversaries%2FMay_20 ( These pages are
 ...
 * @param  {String} year    Year. As string because some events occured 'BC', sometimes also denoted
 * 'BCE' - i.e. '32 BC' or '200 BCE'
 */
class WMFEvent {
...
/**
 * Determines whether a list element is formatted as an event which occured during a year
 * @param  {ListElement}  listElement   List element to examine
 * @return {Boolean}                    True if the list element is about an event which occured
 * during a year
 */
...
/**
 * WMFEvent comparator which properly handles 'BC'/'BCE' years
 ...
 * @return {Dictionary}             Dictionary with keys for arrays of 'births', 'deaths', 'events',
 * 'holidays' and 'selected'
 */
