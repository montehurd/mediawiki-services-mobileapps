...
http.ServerResponse.prototype.wmf_endResponseWithOutput = function(output) {
    this.status(200);
    mUtil.setContentType(this, mUtil.CONTENT_TYPES.onthisday);
    this.json(output).end();
};
...
router.get('/births/:mm/:dd', (req, res) => {
    ...
    .bind(res)
    .then(res.wmf_endResponseWithOutput);
});
